...
Let us define a function&nbsp;<em style="color: rgba(255, 255, 255, 0.87) !important;">f</em>&nbsp;over&nbsp;<strong>B</strong>, which is defined as follows:<br>
<em style="color: rgba(255, 255, 255, 0.87) !important;">f(B) =&nbsp;</em>B<sub>1</sub>&nbsp;- B<sub>2</sub>&nbsp;+ B<sub>3</sub>&nbsp;- B<sub>4</sub>&nbsp;+ B<sub>5</sub>.... + (-1)<sup>(k-1)</sup>B<sub>k</sub>.<br>
You have to find the maximum possible value of&nbsp;<em style="color: rgba(255, 255, 255, 0.87) !important;">f(B)</em>.</span></p>

<p><span style="font-size:18px"><strong>Example 1:</strong></span></p>

<pre style="background-color: rgb(38, 41, 42) !important; color: rgba(232, 229, 227, 0.87) !important; border-color: rgb(128, 111, 105) !important;"><span style="font-size:18px"><strong>Input:</strong>
N = 3,
A = { 1, 2, 3}
P = {-1, 1, 1}
Output:
...
<pre style="background-color: rgb(38, 41, 42) !important; color: rgba(232, 229, 227, 0.87) !important; border-color: rgb(128, 111, 105) !important;"><span style="font-size:18px"><strong>Input:
</strong>N = 3,
A = { 3, 1, 2}
P = {-1, 1, 2}
<strong>Output:
